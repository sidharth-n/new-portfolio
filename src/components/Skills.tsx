  ...
  const skillCategories = [
    {
      ...
      description: "Defining roadmaps and driving product vision",
      skills: ["PRD Writing", "Roadmap Planning", "OKR Setting", "Stakeholder Alignment"],
      color: "primary",
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: "Rapid Prototyping",
      description: "Shipping MVPs fast to validate ideas",
      skills: ["Figma Prototypes", "No-code Tools", "A/B Testing", "User Validation"],
      color: "accent",
    },
    {
      icon: <Cpu className="w-6 h-6" />,
      title: "AI Product Expertise",
      description: "Deep understanding of AI/ML capabilities",
      skills: ["LLMs & Agents", "Prompt Engineering", "AI UX Patterns", "API Integration"],
      color: "primary",
    },
    {
      icon: <Wrench className="w-6 h-6" />,
      title: "Technical Execution",
      description: "Frontend dev skills for hands-on building",
      skills: ["React", "Three.js", "TypeScript", "Tailwind CSS"],
      color: "accent",
    },
  ]
